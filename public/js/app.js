...
document.querySelectorAll('.delete-product__btn').forEach(function (btn) {
  btn.addEventListener('click', function (event) {
    var url = "/schools/".concat(event.target.dataset.id);
    axios["delete"](url).then(function (response) {
      return window.location.reload();
    });
  });
});
document.querySelectorAll('.delete-employee__btn').forEach(function (btn) {
  btn.addEventListener('click', function (event) {
    var url = "/employees/".concat(event.target.dataset.id);
    axios["delete"](url).then(function (response) {
      return window.location.reload();
    });
  });
